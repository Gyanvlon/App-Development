...
}(this, (function (exports, _angular_core, _angular_common, rxjs) {
    'use strict';
                ...
                _this.loadScript(FacebookLoginProvider.PROVIDER_ID, "//connect.facebook.net/en_US/sdk.js", function () {
                    ...
                    FB.getLoginStatus(function (response) {
                        if (response.status === 'connected') {
                            FB.api('/me?fields=id,name,first_name,last_name,age_range,gender,picture,email', function (response) {
                                ...
                                // user.age_range_min = (response.age_range.min) ? response.age_range.min : 0;
                                // user.age_range_max = (response.age_range.max) ? response.age_range.max : 0;
                                resolve(user);
                            });
                        }
                    });
