...
@Component({
    selector: 'app-login-from-checkout',
    templateUrl: './login-from-checkout.component.html',
    styleUrls: ['./login-from-checkout.component.css']
})
export class LoginFromCheckoutComponent implements OnInit {
