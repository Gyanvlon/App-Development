...
export function standardizeIncomingAnalytics(analyticsObject: any, preferNormalStructure: boolean = false) {
...
export function getSanitizedAnalyticsMetadata(analyticMetadata: any, preferNormalStructure: boolean) {
