...
const webpackConfig = {
    ...
    devServer: {
        ...
        proxy: [
            ...
            { path: '/dhis-web-mapping/**', target: dhisConfig.baseUrl, bypass: log },
            { path: '/icons/**', target: dhisConfig.baseUrl, bypass: log },
            { path: '/images/**', target: dhisConfig.baseUrl, bypass: log },
            ...
            { path: '/main.js', target: dhisConfig.baseUrl, bypass: log },
            { path: '/request.js', target: dhisConfig.baseUrl, bypass: log },
        ],
    },
};
